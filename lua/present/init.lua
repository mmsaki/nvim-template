--- Edited from original: https://github.com/tjdevries/present.nvim/blob/master/lua/present.lua
local M = {}
...
local create_window_configurations = function()
  ...
  local body_height = height - header_height - footer_height - 4 - 2 -- for our own border
